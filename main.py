...
path1 = "C:/Users/prade/pulse/data/aggregated/transaction/country/india/state/"
...
path2 = "C:/Users/prade/pulse/data/aggregated/user/country/india/state/"
...
path3 = "C:/Users/prade/pulse/data/map/transaction/hover/country/india/state/"
...
path4 = "C:/Users/prade/pulse/data/map/user/hover/country/india/state/"
...
path5 = "C:/Users/prade/pulse/data/top/transaction/country/india/state/"
...
path6 = "C:/Users/prade/pulse/data/top/user/country/india/state/"
...
db=psycopg2.connect(host='localhost', user='postgres', password="sripradeep", port=5432, database="phonepe")
cursor=db.cursor()
...
for i,row in df_map_trans.iterrows():
    SRI = "INSERT INTO map_trans VALUES (%s,%s,%s,%s,%s,%s)"
    cursor.execute(SRI, tuple(row))
    db.commit()
...
for i,row in df_map_user.iterrows():
    SRI = "INSERT INTO map_user VALUES (%s,%s,%s,%s,%s,%s)"
    cursor.execute(SRI, tuple(row))
    db.commit()
...
for i,row in df_top_trans.iterrows():
    SRI = "INSERT INTO top_trans VALUES (%s,%s,%s,%s,%s,%s)"
    cursor.execute(SRI, tuple(row))
    db.commit()
...
for i,row in df_top_user.iterrows():
    SRI = "INSERT INTO top_user VALUES (%s,%s,%s,%s,%s)"
    cursor.execute(SRI, tuple(row))
    db.commit()