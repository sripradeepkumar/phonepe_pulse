...
db = psycopg2.connect(host='localhost', user='postgres', password='sripradeep',database='phonepe')

cursor = db.cursor()

icon = Image.open("C:/Users/prade/Downloads/phonepe-new.jpg")
st.set_page_config(page_title= "Phonepe Pulse Data Visualization | By SRIPRADEEPKUMAR",
                   page_icon= icon,
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# This dashboard app is created by *SRIPRADEEPKUMAR*!"""})
...
# MENU 1 - HOME
if selected == "Home":
    st.image("C:/Users/prade/Downloads/download.png",width=300)
    ...
    with col2:
        video_file = open("C:/Users/prade/Downloads/Introducing PhonePe Pulse.mp4", 'rb')
...
if selected == "Explore Data":
    ...
    if Type == "Transactions":
        ...
        with col1:
            ...
            df2 = pd.read_csv("C:/Users/prade/Downloads/state.csv")
            df1.State = df2
...
if selected == "About":
    ...
    with col1:
        ...
        st.write("https://github.com/sripradeepkumar/phonepe_pulse/blob/main/main.py")
    ...
    with col2:
        ...
        st.write(" ")
        st.write(" ")
        st.image("C:/Users/prade/Downloads/download.png")